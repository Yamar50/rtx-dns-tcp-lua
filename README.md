...
Yamaha RTXの内蔵UDP DNSと静的ホスト登録を維持し、LuaでTCP DNSを補完します。開発時の実機検証対象は **RTX830 Rev.15.02.33** と **RTX1210 Rev.14.01.42**、どちらも整数版Lua 5.1.5（機能1.08）です。**RTX1300 Rev.23.00.19についても、協力者から実機での動作確認報告をいただいています。** この報告の使用版は未確認で、v0.1.3の実機検証には含めていません。RTX810は未検証です。[動作確認一覧](docs/validation.md#実機)
