...
v1.0.0に向けた確認用の版（Pre-release）です。[対応機種と動作確認状況](https://github.com/Yamar50/rtx-dns-tcp-lua/blob/main/docs/compatibility.md)
...
![管理者モードでコマンドを貼り付けた入力例（画面イメージ）](https://raw.githubusercontent.com/Yamar50/rtx-dns-tcp-lua/main/docs/images/install-console-v099.png)
...
**[技術的な詳しい説明](https://github.com/Yamar50/rtx-dns-tcp-lua/blob/main/docs/README.md)** · [この版の変更内容と検証結果](https://github.com/Yamar50/rtx-dns-tcp-lua/blob/main/docs/releases/v0.9.9-details.md) — 対応機種、仕様、更新・削除、試験結果、ライセンスと免責事項。
