...
**[rtx-dns.luaをダウンロード][download-lua]** · [SHA256SUMS][download-sha]
...
1. Releaseの配布ファイル[rtx-dns.lua][download-lua]と[SHA256SUMS][download-sha]をダウンロードし、SHA-256を確認します。LuaファイルをUSBメモリのルートへ保存し、ルーターへ接続します。
