...
> このブランチの説明はv0.9.9候補版を対象にしています。候補版は公開準備中です。制限緩和の過負荷試験での再起動と、既定制限での追加確認は[負荷試験記録](load-test-v0.9.9.md)に記載しています。現在配布している安定版v0.1.4の導入には、[その版の手順](https://github.com/Yamar50/rtx-dns-tcp-lua/blob/v0.1.4/docs/install.md)を参照してください。
